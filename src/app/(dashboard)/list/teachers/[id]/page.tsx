		...
		<div className="flex-1 p-4 flex flex-col gap-4 xl:flex-row">
			...
			<div className="w-full xl:w-2/3">
				...
				<div className="flex flex-col lg:flex-row gap-4">
					{/* USER INFO CARD */}
					<div className="bg-najSky py-6 px-4 rounded-md flex-1 gap-4">
						<div className="w-1/3">
							<Image
							...
							<div className="flex items-center justify-between gap-2 flex-wrap text-sm font-medium">
								...
								<div className="w-full md:w-1/3 lg:w-full 2xl:w-1/3 flex items-center gap-2">
									<Image
										...
										className=""
									/>
									<span>najlopez@fuzzywuzzy.com</span>
								</div>
								<div className="w-full md:w-1/3 lg:w-full 2xl:w-1/3 flex items-center gap-2">
									<Image
										src="/phone.png"
					...
					{/* SMALL CARD */}
					<div className="flex-1 flex g4 justify-between flex-wrap">
						{/* ATTENDANCE CARD */}
						<div className="bg-white w-full rounded-md gap-4 md:w-[48%] xl:w-[45%] 2xl:w-[48%]">
							<Image
